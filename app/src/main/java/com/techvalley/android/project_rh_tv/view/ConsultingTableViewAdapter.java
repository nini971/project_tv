...
import com.techvalley.android.project_rh_tv.tableview.holder.CellViewHolder;
import com.techvalley.android.project_rh_tv.tableview.holder.ColumnHeaderViewHolder;
import com.techvalley.android.project_rh_tv.tableview.holder.RowHeaderViewHolder;
...
public class ConsultingTableViewAdapter extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell>{
    private static final String LOG_TAG = ConsultingTableViewAdapter.class.getSimpleName();


    public ConsultingTableViewAdapter(Context p_jContext) {
        super(p_jContext);
    }
